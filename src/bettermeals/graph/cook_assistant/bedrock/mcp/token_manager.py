...
_COGNITO_PROVIDER = get_ssm_parameter("/app/cookassistant/agentcore/cognito_provider")
...
class TokenManager:
    ...
    def __init__(self):
        ...
        # Set the path to .agentcore.json in cook_assistant directory
        # Path from bedrock/mcp/ -> bedrock/ -> cook_assistant/
