"""
Memory configuration for Cook Assistant AgentCore integration.

This module handles memory resource initialization and SSM parameter management
for the cook assistant's semantic memory strategy.
"""
...
MEMORY_ID_SSM_PARAM = "/app/cookassistant/agentcore/memory_id"
MEMORY_NAME = "CookAssistantMemory"
MEMORY_DESCRIPTION = "Memory resource for cook assistant with semantic memory strategy"
        ...
        "strategies": [
            {
                "semanticMemoryStrategy": {
                    "name": "CookAssistantSemanticMemory",
